...
"""
There are two types of access modifiers in Python: public, private.
1) Variables\functions with the public access modifiers can be accessed anywhere inside or outside the class.
2) while protected variables can be accessed within the same package.
"""
